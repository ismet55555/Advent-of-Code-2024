...
- Pair smallest number on left list
  **with** smallest number in the right list
- Pair second smallest number on left list
  **with** second smallest number on right list

- For each pair, find absolute difference
- Sum all differences

- Plan
  - Split input by "\n"
  - Split each line by " "
  - Get left and right into two vectors, independently
  - Sort accending (should be default) (itertools: sorted())
  - For each item, calculate difference
  - Sum up all
...
- Plan
  - Loop over left list
  - For each item count how many times in right list
  - Multiply numbers
  - Sum resulting
